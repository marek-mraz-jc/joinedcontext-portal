/**
 * T-2730: every page of one resource (a space, a model, a change, a person, a copy), walked with the API mocked in its not-found state (UI-01, UI-15, UI-16, UI-84).
 *
...
describe("every details page, as the walker finds it (T-2730)", () => {
  it.each(addresses("details"))("%s", expectWalked);
});
