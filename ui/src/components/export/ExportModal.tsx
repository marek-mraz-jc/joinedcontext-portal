...
export function ExportModal({
  ...
  async function download() {
    ...
    setPreparing(true);
    try {
      // A git export is the repository at its default branch: it takes no revision (MF-45).
      const url = exportUrl(project, format, target, format === "git" ? undefined : revision || undefined);
